...
class Calculator:
    ...
    def generate_info_dict_for_singal_building(self, building):
        building_info_list = []
    ...
    def generate_one_line_data(self, combination, pmgs_localization_list):
        one_line_data = {}
        one_line_data['good_input'] = Counter()
        one_line_data['good_output'] = Counter()
        one_line_data['workforce'] = Counter()
    ...
    def transfer_dict_to_df(self, building_info_list, building):
    ...
    def check_workforce_positive(self, workforce_dict: dict):
...
if __name__ == '__main__':
    ...
    test_dict = calculator.generate_info_dict_for_singal_building(calculator.building_info_tree[0])
